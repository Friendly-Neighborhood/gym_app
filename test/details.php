...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save_changes'])) {
    ...
    $sql_fetch = "SELECT personal_info FROM user_info_test WHERE tg_id = $client_id";
    ...
    $sql_update = "UPDATE user_info_test SET personal_info = '$updated_personal_info' WHERE tg_id = $client_id";
...
// Fetch user data
$sql = "SELECT * FROM user_info_test WHERE tg_id = $client_id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save_nutrition_recommendations'])) {
    ...
    $sql_update_nutrition = "UPDATE user_info_test SET recommendations = '$updated_nutrition_data' WHERE tg_id = $client_id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_training'])) {
    ...
    if (!empty($selected_muscles)) {
        ...
        $sql_fetch = "SELECT trainings FROM user_info_test WHERE tg_id = $client_id";
        $result_fetch = $conn->query($sql_fetch);
        $row_fetch = $result_fetch->fetch_assoc();
        ...
        $sql_update = "UPDATE user_info_test SET trainings = '$updated_trainings_json' WHERE tg_id = $client_id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['extend_subscription'])) {
    ...
    if (!empty($new_active_till)) {
        $sql_update_subscription = "UPDATE user_info_test SET active_till = '$new_active_till' WHERE tg_id = $client_id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['cancel_subscription'])) {
    ...
    $sql_cancel_subscription = "UPDATE user_info_test SET active_till = '$yesterday' WHERE tg_id = $client_id";
